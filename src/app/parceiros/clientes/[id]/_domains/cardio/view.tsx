...
const inputClass = "box-border h-10 w-full min-w-0 max-w-full rounded-[8px] border border-[#303746] bg-[#081520] px-3 text-[13px] text-white outline-none focus:border-[#3b97e3]";
...
function ActionButton({ children, disabled, onClick, tone = "ghost", type = "button" }: {
  ...
  return (
    <button
      className={cn(
        "inline-flex h-10 w-full min-w-0 max-w-full items-center justify-center gap-2 rounded-[8px] px-3 text-center text-[13px] font-semibold leading-4 whitespace-normal transition disabled:cursor-not-allowed disabled:opacity-50",
        tone === "primary"
    ...
    <main className="min-h-screen bg-[#0b1720] pb-10 text-white sm:pb-12">
      <div className="mx-auto w-full max-w-[1240px] px-3 py-4 sm:px-6 sm:py-6">
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
          <section className={cn(panelClass, "min-w-0 overflow-hidden p-5")}>
