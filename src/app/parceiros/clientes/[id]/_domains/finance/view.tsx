...
import type { PartnerClientFinanceData, PartnerClientReceivable } from "@/lib/partners/finance-data";
...
export function PartnerClientFinanceView({ finance, overview }: { finance: PartnerClientFinanceData; overview: PartnerClientOverviewData }) {
