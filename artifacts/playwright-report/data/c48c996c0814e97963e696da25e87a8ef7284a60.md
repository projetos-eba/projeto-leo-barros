...
- Name: partner-shell.spec.ts >> partner shell >> supports the mobile menu and signs out
- Location: tests/e2e/partner-shell.spec.ts:48:3
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    12 × unexpected value "http://localhost:3000/login/parceiros"
