...
- O comando administrativo de assinatura e exclusivo de Owner e aceita somente agendar cancelamento ao fim do ciclo ou reverter um agendamento pendente. Ele atualiza `cancel_at_period_end` na Stripe por Edge Function e aguarda o webhook para reconciliar o read model local; nao implementa troca de plano, cancelamento imediato ou escrita local direta.
